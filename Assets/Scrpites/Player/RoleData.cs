...
public class RoleData{
    ...
    public RoleData(RoleType roleType,string rolePath,string arrowPath,string explosionPath, Transform spawPosition)
    {
        ...
        this.SpawnPosition = spawPosition.position;
    }
}
